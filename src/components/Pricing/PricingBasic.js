    ...
    return (
        <>
          ...
          <div className="four-columns column-50-100 padding-top-60">
            <div className="column-l-r-margin-10 price-top-offset border-box border-radius-10px">
              <div className="text-center">
                <h3 className="subhead-s text-color-red padding-top-bottom-20">Basic</h3>
              </div>
              <h4 className="text-center content-bg-red padding-top-bottom-40">
                <span className="headline-l"> £375</span><br />
              ...
              <div className="accordion accordion_underline js-accordion js-accordion-first-active margin-left-right-20 margin-top-bottom-50">
                ...
                <div className="accordion__tab js-accordion-tab">
                  ...
                  <div className="accordion__content js-accordion-content">
                    ...
                    <ul className="list list_center subhead-xxs text-color-b0b0b0 margin-top-10">
                      <li className="list__item check red">1 - 3 pages </li>
                      <li className="list__item check red">Responsive web design</li>
                      <li className="list__item check red">Slideshow animation </li>
                      <li className="list__item check red">Clean, Simple and Modern Website Design</li>
                      <li className="list__item check red">Secure Contact Form</li>
                      <li className="list__item x opacity-05">Testimonial carousel</li>
                      <li className="list__item x opacity-05">Modern animations</li>
                    </ul>{/* list end */}
                  </div>
                ...
                <div className="accordion__tab js-accordion-tab">
                  ...
                  <div className="accordion__content js-accordion-content">
                    {/* list start */}
                    <ul className="list list_center subhead-xxs text-color-b0b0b0 margin-top-10">
                      <li className="list__item check red">12 months FREE hosting</li>
                      ...
                      <li className="list__item check red">Up to 3 business emails</li>
                    </ul>{/* list end */}
                  </div>
                </div>{/* accordion__tab end */}
                {/* accordion__tab start */}
                <div className="accordion__tab js-accordion-tab">
                  ...
                  <div className="accordion__content js-accordion-content">
                    ...
                    <ul className="list list_center subhead-xxs text-color-b0b0b0 margin-top-10">
                      ...
                      <li className="list__item check red">Basic on-page SEO optimisation</li>
                      <li className="list__item x opacity-05">
                        Google Analytics</li>
                      <li className="list__item x opacity-05">Google Maps Listing</li>
                      <li className="list__item x opacity-05">Digital Visibility</li>
                    </ul>{/* list end */}
                  </div>
                </div>{/* accordion__tab end */}
                {/* accordion__tab start */}
                <div className="accordion__tab js-accordion-tab">
                  <div className="accordion__btn js-accordion-btn js-pointer-large">
                    <h6 className="accordion__btn-title headline-xxxxs">Branding &amp; Marketing</h6>
                  </div>
                  <div className="accordion__content js-accordion-content">
                    {/* list start */}
                    <ul className="list list_center subhead-xxs text-color-b0b0b0 margin-top-10">
                      <li className="list__item check red">Social Media Marketing Pla</li>
                      ...
                      <li className="list__item x opacity-05">Vinyl snackwave</li>
              ...
              <div className="padding-bottom-40 text-center">
                <a href="#" className="ellipse-btn js-pointer-large">sign up</a>
              </div>
            </div>
          </div>{/* column end */}
        </>
